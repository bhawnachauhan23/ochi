...
function Footer(){
  return (
    <div className="flex gap-5 w-full h-screen py-20 px-16 font-['Founders_Grotesk_X_Condensed'] ">
      ...
      <div className="w-1/2">
        ...
        <div className="dets font-['Neue_Montreal'] mt-10">
          <h3 className="text-[1.2vw] font-light mb-4">S:</h3>
          <a className="block text-[1.2vw] font-light" href="#">
            Instagram
          </a>
          <a className="block text-[1.2vw] font-light" href="#">
            Behance
          ...
          <h3 className="text-[1.2vw] font-light mt-8 mb-4">L:</h3>
          <a className="block text-[1.2vw] font-light" href="#">
            202-1965 W 4th Ave
          </a>
          <a className="block text-[1.2vw] font-light mb-4" href="#">
            Vancouver, Canada
          </a>
          <a className="block text-[1.2vw] font-light" href="#">
            30 Chukarina St
          ...
          <h3 className="text-[1.2vw] font-light mt-8 mb-4">E:</h3>
          <a className="block text-[1.2vw] font-light" href="#">
            hello@ochi.design
          </a>
        </div>
        <div className="dets font-['Neue_Montreal'] mt-10">
        <h3 className="text-[1.2vw] font-light mb-4">M:</h3>
          <a className="block text-[1.2vw] font-light" href="#">
            Home
          </a>
          <a className="block text-[1.2vw] font-light" href="#">
